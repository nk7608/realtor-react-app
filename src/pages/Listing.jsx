...
export default function Listing() {
  ...
  return (
   <main>
      ...
      <div className="m-4 flex flex-col md:flex-row max-w-2xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white">
...
<FaMapMarkerAlt className="text-green-700 mr-1" />     
 ...
 <div className="flex justify-start items-center space-x-4 w-[75%]">
  ...
  {listing.offer && (
    <p className="w-full max-w-[200px] bg-green-800 rounded-md p-1 text-white text-center font-semibold shadow-md">${+(listing.regularPrice) - +(listing.discountedPrice)} dicount</p>
  )}
 </div>
